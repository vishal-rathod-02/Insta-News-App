...
// 1. Type Definition for consistent props (allows Tailwind classes)
...
// ==========================================
// UTILITY ICONS (Sidebar Features)
// ==========================================
...
export const CloudIcon: React.FC<IconProps> = ({ className = "w-6 h-6", ...props }) => (
  ...
  >
    ...
    <path d="M19 19a3 3 0 0 0 2.8-4" />
    <path d="M17 19h-5" />
    <path d="M12 13.5V7" />
    <path d="M12 7a5 5 0 0 1 4.5 7" />
    <path d="M12 7a5 5 0 0 0-4.5 7" />
    <path d="M7.5 19H5a2 2 0 0 1-2-2v-1a5 5 0 0 1 5-5" />
  </svg>
);
...
export const CopyIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
