      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-oled-black p-4 font-sans selection:bg-violet-500/30">
          <div className="relative group max-w-2xl w-full">
            ...
            <div className="relative p-[1px] rounded-3xl bg-linear-to-b from-violet-200 to-fuchsia-100 dark:from-violet-500/50 dark:to-fuchsia-500/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(139,92,246,0.1)] transition-all duration-300">
