  ...
  return (
    <div className="w-full flex justify-center py-12">
      <div className="relative group max-w-md w-full">
        ...
        <div className="relative p-px rounded-2xl bg-linear-to-b from-red-200 to-orange-100 dark:from-red-500/50 dark:to-orange-500/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(239,68,68,0.15)] transition-all duration-300">
